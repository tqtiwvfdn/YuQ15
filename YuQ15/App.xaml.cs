...
namespace YuQ15
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            if (mySetting.Contains("HostPath"))
            {
                HostPath = (string)mySetting["HostPath"];
            }

            if (mySetting.Contains("backgroundImage"))
            {
                backgroundImage = (string)mySetting["backgroundImage"];
            }else
            {
                backgroundImage = AppResources.backgroundImage;
            }
        }
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            {
                if (PhoneApplicationService.Current.State.ContainsKey("HostPath"))
                {
                    HostPath = PhoneApplicationService.Current.State["HostPath"] as string;
                }
                if (PhoneApplicationService.Current.State.ContainsKey("backgroundImage"))
                {
                    backgroundImage = PhoneApplicationService.Current.State["backgroundImage"] as string;
                }
            }
        }
        ...
        private void Application_Deactivated(object sender, DeactivatedEventArgs e)
        {
            ...
            {
                PhoneApplicationService.Current.State["HostPath"] = HostPath;
            }
            if (!string.IsNullOrEmpty(backgroundImage))
            {
                PhoneApplicationService.Current.State["backgroundImage"] = backgroundImage;
            }
        }
